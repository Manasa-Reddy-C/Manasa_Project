...
SECRET_KEY = 'django-insecure-*vxb6=n0cc1pvj752+7n_)x%qvnu#9a#c!i@$@4$op%6b)mtz*'
...
# add this code
SOCIAL_AUTH_INSTAGRAM_KEY = 'xxxxxxxxxxxxxxxxxxxx'         
SOCIAL_AUTH_INSTAGRAM_SECRET = 'xxxxxxxxxxxxxxxxxxxx'  
